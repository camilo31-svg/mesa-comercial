...
export function detectObjections(text){
 ...
 if(/\b(iban|numero de cuenta|numero de tarjeta|mi dni|mi nif)\b/.test(t)&&!/\b(no doy|no compart|no quiero dar|no dare|me pides|me piden)\b/.test(t))return [special.privacy];
