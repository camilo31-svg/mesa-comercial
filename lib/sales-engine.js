...
export function scriptFor(text,selectedId,mode,context={}){
 ...
 const selected=["stop","exactitud","pressure","privacy","ready","conditional","pending","guarantee","no_need","callback"].includes(matches[0]?.id)?matches[0]:objections.find(x=>x.id===selectedId)||matches[0];
